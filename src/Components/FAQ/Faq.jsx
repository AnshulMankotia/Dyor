    ...
    <div className="container">
        <div className="testimonial">
            <div className="t-heading">
                <h3>FAQ's</h3>
                <h2>
                Don't guess, know the answers
                </h2>
                <p>
                Our FAQ's section is designed to help clear up any confusion <br /> you may have about our products or services
                </p>
          ...
          <div className="column" id="column1">
            <div className="t-content flex-column">
              <div className="t-content1 flex-row">
               <h3>What is Dyor and how does it work?</h3>
              </div>
